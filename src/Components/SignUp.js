        ...
        <form className='login' onSubmit={handleSubmit}>
            <Card className='login-card' >
                ...
                <div className='login-input'>
                    ...
                    <p className='text'>Don't have an account <span onClick={() => navigate(`/bl_users/login`)} className='nav'>Login</span> here</p>
                </div>
            </Card>
        </form>
    )
